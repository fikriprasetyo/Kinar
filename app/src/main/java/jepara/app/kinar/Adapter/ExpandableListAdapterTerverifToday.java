...
public class ExpandableListAdapterTerverifToday extends BaseExpandableListAdapter {

    private Context _context;
    private List<String> _listDataHeader;
    private HashMap<String, List<content_terveriftoday>> _listDataChild;

    public ExpandableListAdapterTerverifToday(Context _context, List<String> _listDataHeader, HashMap<String, List<content_terveriftoday>> _listDataChild) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        content_terveriftoday investment = (content_terveriftoday) getChild(groupPosition, childPosition);
