...
public class ExpandableListAdapterTerverifMonth extends BaseExpandableListAdapter {

    private Context _context;
    private List<String> _listDataHeader;
    private HashMap<String, List<content_terverifmonth>> _listDataChild;

    public ExpandableListAdapterTerverifMonth(Context _context, List<String> _listDataHeader, HashMap<String, List<content_terverifmonth>> _listDataChild) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        content_terverifmonth investment = (content_terverifmonth) getChild(groupPosition, childPosition);
