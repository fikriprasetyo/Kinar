...
public class ExpandableListAdapterUnverifMonth extends BaseExpandableListAdapter {

    private Context _context;
    private List<String> _listDataHeader;
    private HashMap<String, List<content_unverifmonth>> _listDataChild;

    public ExpandableListAdapterUnverifMonth(Context _context, List<String> _listDataHeader, HashMap<String, List<content_unverifmonth>> _listDataChild) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        content_unverifmonth investment = (content_unverifmonth) getChild(groupPosition, childPosition);
